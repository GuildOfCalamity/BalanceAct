...
namespace BalanceAct.Behaviors
{
    ...
    {
        static readonly bool IsXamlRootAvailable = ApiInformation.IsPropertyPresent("Microsoft.UI.Xaml.UIElement", "XamlRoot");
        ScrollViewer? _scrollViewer;
        CompositionPropertySet? _scrollProperties;
        CompositionPropertySet? _animationProperties;
        Visual? _headerVisual, _itemsPanelVisual;
        InsetClip? _contentClip;
        readonly DispatcherTimer _assignAnimationTimer;
        ...
        bool AssignAnimation()
        {
            ...
            headerElement.SizeChanged -= ScrollHeaderOnSizeChanged;
            headerElement.SizeChanged += ScrollHeaderOnSizeChanged;
        ...
        void RemoveAnimation()
        {
            if (HeaderElement is FrameworkElement element)
                element.SizeChanged -= ScrollHeaderOnSizeChanged;
        ...
        void ScrollHeaderOnSizeChanged(object sender, SizeChangedEventArgs e) => AssignAnimation();
    }
